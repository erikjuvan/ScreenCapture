//How can I save a screenshot directly to a file in Windows? - Stack Overflow - http://stackoverflow.com/questions/158151/how-can-i-save-a-screenshot-directly-to-a-file-in-windows
...
public class IntercaptCaptureScreen {
    ...
    private const int VK_SNAPSHOT = 0X2C; // Virtual-Key Code for print-screen button
    private static LowLevelKeyboardProc _proc = HookCallback;
    private static IntPtr _hookID = IntPtr.Zero;
    private static int iUserInput = 0;

    static public void Main(string[] args) {
        //CaptureScreenshot(); // test
        Console.WriteLine("Welcome to InterceptCaptureScreen\nUse \"print-screen\" to take a screenshot...");
        Console.WriteLine("... press CTRL+C to exit...\n");
        Console.WriteLine("Select image format:");
        Console.WriteLine("1 - JPEG");
        Console.WriteLine("2 - PNG");
        Console.WriteLine("3 - GIF");
        Console.WriteLine("4 - BMP");
        iUserInput = Console.Read();

        if (iUserInput == '1')
            Console.WriteLine("JPEG Selected...\n");
        else if (iUserInput == '2')
            Console.WriteLine("PNG Selected...\n");
        else if (iUserInput == '3')
            Console.WriteLine("GIF Selected...\n");
        else if (iUserInput == '4')
            Console.WriteLine("BMP Selected...\n");
        else
            Console.WriteLine("Default - JPEG Selected...\n");
    ...
    public static void CaptureScreenshot() {
        try {
            ...
            String tsstr = timestamp.ToString("ddd-dd-MM-yyyy_HH-mm-ss.f", CultureInfo.CreateSpecificCulture("en-US"));
            String tfname = tsstr + "-screen";
            if (iUserInput == '1') {
                tfname = tfname + ".jpg";
